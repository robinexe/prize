...
export default function JetSkiViewer3D({ interactive = false }: { interactive?: boolean }) {
  return (
    <Canvas
      camera={{ position: [0, 1.5, 4], fov: 45 }}
      style={{ pointerEvents: interactive ? 'auto' : 'none', background: 'transparent' }}
      gl={{ alpha: true }}
    >
...
useGLTF.preload('/jetski.glb', true);
