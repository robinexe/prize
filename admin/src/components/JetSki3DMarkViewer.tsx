...
function ViewerScene({ marks, markColor = '#ef4444', secondaryMarks = [], secondaryMarkColor = '#39ff14' }: { marks: MarkPoint[]; markColor?: string; secondaryMarks?: MarkPoint[]; secondaryMarkColor?: string }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 cursor-grab active:cursor-grabbing"
      ...
      <ModelErrorBoundary>
        ...
        >
          <ViewerScene marks={marks} markColor={markColor} secondaryMarks={secondaryMarks} secondaryMarkColor={secondaryMarkColor} />
        </Canvas>
      </ModelErrorBoundary>
      {totalMarks > 0 && (
